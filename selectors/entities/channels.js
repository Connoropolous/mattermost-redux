...
var getUnreads = exports.getUnreads = (0, _reselect.createSelector)(getAllChannels, getMyChannelMemberships, function (channels, myMembers) {
    var messageCount = 0;
    var mentionCount = 0;
...
var getUnreadChannelIds = exports.getUnreadChannelIds = (0, _helpers.createIdsSelector)(getAllChannels, getMyChannelMemberships, getChannelIdsForCurrentTeam, function (state) {
...
var getSortedUnreadChannelIds = exports.getSortedUnreadChannelIds = (0, _helpers.createIdsSelector)(_common.getCurrentUser, _common.getUsers, getAllChannels, getMyChannelMemberships, getUnreadChannelIds, _preferences.getTeammateNameDisplaySetting, function (state) {
    var lastUnreadChannel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    return lastUnreadChannel;
}, function (currentUser, profiles, channels, members, unreadIds, settings, lastUnreadChannel) {
...
var getSortedPublicChannelWithUnreadsIds = exports.getSortedPublicChannelWithUnreadsIds = (0, _helpers.createIdsSelector)(_common.getCurrentUser, getAllChannels, getMyChannelMemberships, getChannelIdsForCurrentTeam, getSortedFavoriteChannelWithUnreadsIds, function (currentUser, channels, myMembers, teamChannelIds, favoriteIds) {
    if (!currentUser) {
        return [];
    }
